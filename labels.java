...
public class labels {
    ...
    label.setFont(new Font("Baskerville", Font.PLAIN,20));//set font of text
    ...
    frame.add(label);
    frame.pack();//resize the frame automatically it should appear after all components have being added to the frame.
    }
}
